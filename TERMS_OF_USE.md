...
By installing or using Aura Media Downloader, you agree to use it lawfully and in accordance with the applicable website terms, copyright rules, and licenses.

## Authorized use only

You are responsible for having the rights, permission, or other lawful authorization required for every media resource you detect or download. Do not use the extension to copy, distribute, or monetize third-party copyrighted media without permission. The extension does not authorize any download merely because a resource is technically detectable.
...
Questions: `[OWNER INPUT: SUPPORT_EMAIL]`. Updated terms will be published at `[OWNER INPUT: TERMS_OF_USE_HTTPS_URL]` with a new effective date.
